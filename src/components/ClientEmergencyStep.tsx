  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
      ...
      <div className="px-6 pt-6 pb-4 border-b border-gray-100">
        <h2 className="text-xl font-bold text-forest-green">Emergency Contact</h2>
      ...
      <form onSubmit={handleSubmit(onSubmit)} noValidate>
        <div className="px-6 py-5 flex flex-col gap-4">
          ...
          <div>
            <label htmlFor="emergencyName" className="block text-sm font-semibold text-charcoal mb-1.5">
          ...
          {/* Emergency Phone */}
          <div>
            <label htmlFor="emergencyPhone" className="block text-sm font-semibold text-charcoal mb-1.5">
          ...
          {/* Relationship */}
          <div>
            <label htmlFor="emergencyRelation" className="block text-sm font-semibold text-charcoal mb-1.5">
