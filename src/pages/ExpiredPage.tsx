  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center px-6 py-12">
      ...
      <div className="text-center mb-8">
        <div className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-forest-green mb-4 shadow-lg">
          <span className="text-gold font-black text-2xl tracking-tight">JJAI</span>
        </div>
      ...
      {/* Card */}
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 w-full max-w-sm px-8 py-8 text-center space-y-5">
        {/* Icon */}
        ...
        <div>
          <h1 className="text-xl font-bold text-forest-green mb-2">
        ...
        <div className="border-t border-gray-100 pt-5 space-y-3">
          ...
          <a
            ...
            className="flex items-center justify-center gap-2 text-forest-green font-semibold hover:opacity-75 transition-opacity"
          >
